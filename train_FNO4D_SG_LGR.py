...
for ep in range(51):
    ...
    for data in train_loader:
        ...
        if c%10 ==0:
            writer.add_scalars('SG LPloss', {f'{model_str}_{specs}_train': loss.item()}, ep*n_train+c)
    ...
    writer.add_scalars('SG LPloss', {f'{model_str}_{specs}_train': train_lp/n_train, 
