...
for names in to_load_names:
    ...
    meta_data = np.load(f'{ROOT_PATH}/ECLIPSE/meta_data/{slope_name}_{idx}.npy', 
    ...
    for well in WELL_LIST:
        ...
        data['input'] = x_DP
        data['output'] = y_DP
        print(f'{slope_name}_{idx}_LGR4_{well}_DP.pt')

        torch.save(data, f'../dataset/dP_LGR4/{slope_name}_{idx}_LGR4_{well}_DP.pt')